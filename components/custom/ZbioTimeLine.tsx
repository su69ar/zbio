  ...
  const data = [
    {
      ...
      content: (
        <div>
          ...
          ZBIO collects organic food waste directly from your restaurant, hotel, or kitchen. Our logistics system ensures timely, clean, and efficient waste retrieval with minimal disruption to your operations.
          </p>
