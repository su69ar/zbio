export default function Statistics() {
  const stats = [
    ...
    {
      number: '2026',
      label: 'Organic waste can no longer go to landfills (TPA)',
    },
  ]
        ...
        <div className='text-center mb-16'>
          ...
          <div className='max-w-3xl mx-auto'>
            <p className='text-[20px]  text-white/90 leading-relaxed'>
              Bali generates a significant amount of waste each year, much of it
              organic and harmful to the environment when left unmanaged.
              {/* A major contributor is the hospitality sector, including hotels, resorts, and
